...
class AccountRepositoryImplTest {
    ...
    @Test
    fun `createAccount should insert account and return generated id`() = runTest {
    ...
    @Test
    fun `createAccount should handle different account types`() = runTest {
        val now = Clock.System.now()
    ...
    @Test
    fun `createAccount should handle different currencies`() = runTest {
        val now = Clock.System.now()
    ...
    @Test
    fun `createAccount should handle negative initial balance`() = runTest {
        val now = Clock.System.now()
        val account = Account(
            name = "Credit Card",
    ...
    @Test
    fun `createAccount should handle zero balance`() = runTest {
        val now = Clock.System.now()
        val account = Account(
            name = "New Account",
            type = AccountType.CHECKING,
    ...
    @Test
    fun `createAccount should handle optional fields`() = runTest {
        val now = Clock.System.now()
        val account = Account(
            name = "Test Account",
            type = AccountType.CHECKING,
    ...
    @Test
    fun `createAccount should handle inactive account`() = runTest {
        val now = Clock.System.now()
        val account = Account(
    ...
    @Test
    fun `getAllAccounts should return empty list when no accounts exist`() = runTest {
        val accounts = repository.getAllAccounts().first()
        assertTrue(accounts.isEmpty())
    }

    @Test
    fun `getAllAccounts should return all accounts`() = runTest {
        val now = Clock.System.now()
    ...
    @Test
    fun `getAllAccounts should return both active and inactive accounts`() = runTest {
        val now = Clock.System.now()
    ...
    @Test
    fun `getAccountById should return null for non-existent id`() = runTest {
        val account = repository.getAccountById(999L).first()
        assertNull(account)
    }

    @Test
    fun `getAccountById should return correct account`() = runTest {
        val now = Clock.System.now()
        val account = Account(
            name = "Test Account",
            type = AccountType.CHECKING,
    ...
    @Test
    fun `getAccountById should return inactive account`() = runTest {
        val now = Clock.System.now()
        val account = Account(
            name = "Inactive Account",
            type = AccountType.CHECKING,
    ...
    @Test
    fun `getActiveAccounts should return empty list when no active accounts exist`() = runTest {
        val now = Clock.System.now()
        val inactiveAccount = Account(
            name = "Inactive Account",
            type = AccountType.CHECKING,
    ...
    @Test
    fun `getActiveAccounts should return only active accounts`() = runTest {
        val now = Clock.System.now()
    ...
    @Test
    fun `getActiveAccounts should return empty list when no accounts exist`() = runTest {
        val accounts = repository.getActiveAccounts().first()
        assertTrue(accounts.isEmpty())
    }
    ...
    @Test
    fun `updateAccount should not modify initial balance`() = runTest {
        val now = Clock.System.now()
        val account = Account(
            name = "Test Account",
            type = AccountType.CHECKING,
    ...
    @Test
    fun `updateAccount should toggle isActive status`() = runTest {
        val now = Clock.System.now()
        val account = Account(
            name = "Test Account",
            type = AccountType.CHECKING,
    ...
    @Test
    fun `updateAccount should handle clearing optional fields`() = runTest {
        val now = Clock.System.now()
        val account = Account(
            name = "Test Account",
            type = AccountType.CHECKING,
    ...
    @Test
    fun `deleteAccount should not affect other accounts`() = runTest {
        val now = Clock.System.now()
        val account1 = Account(
            name = "Account 1",
            type = AccountType.CHECKING,
    ...
    @Test
    fun `deleteAccount should succeed for non-existent id`() = runTest {
    ...
    @Test
    fun `getAllAccounts flow should emit updated list after creation`() = runTest {
        val now = Clock.System.now()
    ...
    @Test
    fun `getActiveAccounts flow should emit updated list after deactivation`() = runTest {
        val now = Clock.System.now()
        val account = Account(
            name = "Test Account",
            type = AccountType.CHECKING,
    ...
    @Test
    fun `should handle large number of accounts`() = runTest {
        val now = Clock.System.now()
    ...
    @Test
    fun `should preserve precision for balance values`() = runTest {
        val now = Clock.System.now()
    ...
    @Test
    fun `should handle very large balance values`() = runTest {
        val now = Clock.System.now()
    ...
    @Test
    fun `should maintain account order consistency`() = runTest {
        val now = Clock.System.now()
