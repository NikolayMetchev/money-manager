...
class TransactionRepositoryImplTest : DbTest() {
    ...
    fun `createTransfer should insert transaction and transfer`() =
        runTest {
            ...
            val retrieved = repositories.transactionRepository.getTransactionById(createdTransfer.id.id).first()
    ...
    fun `updateTransfer should fail when changing to same source and target accounts`() =
        runTest {
            ...
            val created = repositories.transactionRepository.getTransactionById(createdTransfer.id.id).first()
    ...
    fun `deleteTransaction should remove transaction`() =
        runTest {
            ...
            // Delete transaction
            repositories.transactionRepository.deleteTransaction(createdTransfer.id.id)

            val deleted = repositories.transactionRepository.getTransactionById(createdTransfer.id.id).first()
