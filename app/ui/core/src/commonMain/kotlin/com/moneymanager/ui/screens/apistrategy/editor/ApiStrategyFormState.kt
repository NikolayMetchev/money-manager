...
fun extractFormStateFromStrategy(strategy: ApiImportStrategy): ApiStrategyFormState =
    ApiStrategyFormState(
        ...
        accountNamePrefix = strategy.accountNamePrefix,
...
fun buildStrategyFromApiFormState(
    ...
    ApiImportStrategy(
        ...
        // Prefixes legitimately end in a separator space (e.g. "Monzo: "), so they are not trimmed.
        accountNamePrefix = state.accountNamePrefix,
        counterpartyPrefix = state.counterpartyPrefix,
