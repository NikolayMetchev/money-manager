...
class ConversionTradeReconcilerTest {
    ...
    fun matchesTheDebitedLegWhateverTheCreditedAmountIs() {
        ...
        val existing = leg("2021-01-01T09:43:33Z", "90.89657258")
    ...
    fun doesNotMatchAnotherAccountsConversion() {
        val existing = leg("2021-01-01T09:43:33Z", "90.89657258", account = other)
    ...
    fun twoIncomingTradesNeverBothTakeOneLeg() {
        ...
        assertNotNull(reconciler.match(incoming("2021-01-01T09:43:33Z", "90.89657258", key = "api-1")))
        assertNull(reconciler.match(incoming("2021-01-01T09:43:33Z", "90.89657258", key = "api-2")))
    }

    @Test
    fun matchesEachSweptAssetAgainstItsOwnLeg() {
        val reefLeg = leg("2021-01-01T09:43:33Z", "90.89657258")
        val psgLeg = leg("2021-01-01T09:43:33Z", "0.00187671", debitedAsset = usdt)
